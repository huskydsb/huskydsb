...
// prettier-ignore
const ZHT = ['香港','澳門','台灣','日本','韓國','新加坡','美國','英國','法國','德國','澳洲','阿聯酋','阿富汗','阿爾巴尼亞','阿爾及利亞','安哥拉','阿根廷','亞美尼亞','奧地利','亞塞拜然','巴林','孟加拉國','白俄羅斯','比利時','貝里斯','貝寧','不丹','玻利維亞','波斯尼亞和黑塞哥維那','波札那','巴西','英屬維京群島','汶萊','保加利亞','布吉納法索','蒲隆地','柬埔寨','喀麥隆','加拿大','維德角','開曼群島','中非共和國','查德','智利','哥倫比亞','葛摩','剛果(布)','剛果(金)','哥斯大黎加','克羅埃西亞','賽普勒斯','捷克','丹麥','吉布提','多明尼加共和國','厄瓜多爾','埃及','薩爾瓦多','赤道幾內亞','厄立特里亞','愛沙尼亞','衣索比亞','斐濟','芬蘭','加彭','岡比亞','喬治亞','迦納','希臘','格陵蘭','瓜地馬拉','幾內亞','蓋亞那','海地','宏都拉斯','匈牙利','冰島','印度','印尼','伊朗','伊拉克','愛爾蘭','曼島','以色列','義大利','象牙海岸','牙買加','約旦','哈薩克','肯亞','科威特','吉爾吉斯','寮國','拉脫維亞','黎巴嫩','賴索托','賴比瑞亞','利比亞','立陶宛','盧森堡','北馬其頓','馬達加斯加','馬拉威','馬來西亞','馬爾地夫','馬利','馬爾他','茅利塔尼亞','模里西斯','墨西哥','摩爾多瓦','摩納哥','蒙古','蒙特內哥羅','摩洛哥','莫三比克','緬甸','納米比亞','尼泊爾','荷蘭','紐西蘭','尼加拉瓜','尼日','奈及利亞','北韓','挪威','阿曼','巴基斯坦','巴拿馬','巴拉圭','秘魯','菲律賓','葡萄牙','波多黎各','卡達','羅馬尼亞','俄羅斯','盧安達','聖馬利諾','沙烏地阿拉伯','塞內加爾','塞爾維亞','獅子山','斯洛伐克','斯洛維尼亞','索馬利亞','南非','西班牙','斯里蘭卡','蘇丹','蘇利南','斯威士蘭','瑞典','瑞士','敘利亞','塔吉克','坦尚尼亞','泰國','多哥','東加','千里達和托巴哥','突尼西亞','土耳其','土庫曼','美屬維京群島','烏干達','烏克蘭','烏拉圭','烏茲別克','委內瑞拉','越南','葉門','尚比亞','辛巴威','安道爾','留尼旺','波蘭','關島','梵蒂岡','列支敦士登','庫拉索','塞席爾','南極','直布羅陀','古巴','法羅群島','奧蘭群島','百慕達','東帝汶'];
// prettier-ignore
  ...
  const n = e.reduce((acc, curr) => {
    ...
    if (t) {
      ...
      acc.push({
        ...
        items: [{
          ...curr,
          name: `${curr.name} ${toSuperscript("01")} ${FNAME}`
        }],
      });
    }
    return acc;
